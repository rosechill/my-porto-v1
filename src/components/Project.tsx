          ...
          <div>
            ...
            <div className="py-4">
              ...
              <div className="flex lg:flex-row flex-col gap-4">
                <div>
                  <Image
                    className="lg:h-[300px] h-[200px] lg:w-[600px] lg:min-w-[600px] w-full rounded-lg"
                    src="/geoservice.png"
                    width={600}
                    height={400}
            ...
            {backdrops.map(b => (
              <div className="py-4" key={b}>
                ...
                <div className="flex lg:flex-row flex-col gap-4">
                  <div>
                    <Image
                      className="cursor-pointer lg:h-[300px] h-[200px] lg:w-[600px] lg:min-w-[600px] w-full rounded-lg"
                      key={b}
